...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					<li><a href="https://github.com/luisplata/BuscadorDeRutas" target="_blank" class="icon fa-github"><span class="label">Github</span></a></li>
					<!--<li><a href="#" class="icon fa-twitter"><span class="label">Twitter</span></a></li>-->
					<!--<li><a href="https://www.instagram.com/todos_en_la_web/" target="_blank" class="icon fa-website"><span class="label">Instagram</span></a></li>-->
				</ul>
				<p class="copyright">&copy; <a href="https://luisplata.github.io/" target="_blank">Luis Plata</a>.</p>
			</footer>
